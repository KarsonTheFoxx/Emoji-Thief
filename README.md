# Welcome to Emoji Theif
Tired of searching for emojis you spot on discord that you wish to use? Just install this user app and steal the emoji!
Emoji Theif is able to turn all custom static and animated emojis into a downloadable PNG or GIF for easy emoji gathering.
...
[You can find those here](https://github.com/KarsonTheFoxx/Emoji-Theif)

Emoji Theif is very easy to use
...
Emoji Theif will then work it's magic and within seconds you will have the downloadable PNG or GIF directly in your chat!
![A screenshot showing an example reply from the bot](images/image.png)

LIMITATIONS:
1. Discord imposes a hard limit of 10 images on a message, for this reason Emoji Theif can only gather the first 10 emojis in a message and will not gather anything past the first 10
2. Emoji Theif cannot grab emojis from embeds it can only grab emojis that are in a regular text message

TODO:
1. Implement a way for Emoji Theif to gather more than 10 emojis from a message (This will likely be a UI, seperate embed or formatting it into a zip file)
2. Implement the ability to read embed content such as bot embeds
3. Implement GIF support (Allowing Emoji Theif to find the name of a GIF so you can find it in the built in GIF search)
